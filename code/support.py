...
def coast_importer(col, rows, *path):
	frame_dict = import_tilemap(col, rows, *path)
	new_dict = {}
...
def check_connections(radius, entity, target, tolerance = 30):
	...
	if relation.length() < radius:
		#Miro hacia la izquierda y estoy a la derecha del oponente 
		#Miro hacia la derecha y estoy a la izquierda del oponente 
		#Miro hacia la arriba y estoy abajo del oponente 
		#Miro hacia la abajo y estoy arriba del oponente 
