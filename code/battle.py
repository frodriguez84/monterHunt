...
class Battle:
    ...
    def update_all_monster(self, option):
        for monster_sprite in self.player_sprites.sprites() + self.opponent_sprites.sprites():
    ...
    def apply_attack(self, target_sprite, attack, amount):
        ...
        # Get the correct attack amount (defense, element)
    ...
    def draw_attacks(self):
        ...
        for index, ability in enumerate(abilities):
            ...
            # Rect
            y_vector = item_height / 2 + index * item_height + v_offset
            text_rect = text_surf.get_frect(center = bg_rect.midtop + vector(0, y_vector))
    ...
    def draw_switch(self):
        ...
        for index, monster in enumerate(self.available_monsters.values()):
            ...
            item_bg_rect = pygame.FRect((0,0), (width, height)).move_to(midleft = (bg_rect.left, bg_rect.top + item_height /2 + index * item_height + v_offset))
            ...
            if bg_rect.collidepoint(item_bg_rect.center):
                ...
                healt_rect = pygame.FRect((text_rect.bottomleft + vector(0,4)), (100,4))
                energy_rect = pygame.FRect((healt_rect.bottomleft + vector(0,2)), (80,4))
                draw_bar(self.display_surface, healt_rect, monster.health, monster.get_stat('max_health'), COLORS['red'], COLORS['black'])
